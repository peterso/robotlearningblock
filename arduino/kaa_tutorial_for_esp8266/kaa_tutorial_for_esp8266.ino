...
const String TOKEN = "m5stickcplus_0";        // Endpoint token - you get (or specify) it during device provisioning
const String APP_VERSION = "bvgtcvlbhnjfabjf5um0-v1";  // Application version - you specify it during device provisioning

...
void microros_main(void *arg)
{
    ...
    TimedOperation publish_taskboard_status(TASKBOARD_STATUS_PUBLISHER_PERIOD_MS, [&microros_controller, &task_board_driver](){
    ...
    TimedOperation publish_task_status(TASK_STATUS_PUBLISHER_PERIOD_MS, [&microros_controller, &task_executor, &task_board_driver](){
